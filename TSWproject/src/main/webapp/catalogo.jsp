		...
		<div class="wrapper">
		    ...
		    <div class="content">
		    	...
		    	<div class="music-display">
		        	<iframe title="" allow="autoplay *; encrypted-media *;" frameborder="0" height="450" style="width:100%;max-width:660px;overflow:hidden;background:transparent;" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-storage-access-by-user-activation allow-top-navigation-by-user-activation" src="https://embed.music.apple.com/it/album/experience-hendrix-the-best-of-jimi-hendrix/344799413" id="hendrix"></iframe>
